...
<body>
    <div class="header">
        <h1>{{ $title ?? 'Medventory: Medical Equipment Inventory System' }}</h1>
    ...
    <div class="footer">
        <div class="footer-grid">
            ...
            <div>
                <strong>Generated by:</strong> Medventory: Medical Equipment Inventory System<br>
        ...
        <div>© {{ date('Y') }} Medventory: Medical Equipment Inventory System</div>
